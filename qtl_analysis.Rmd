...
gen_map_url <- "https://docs.google.com/spreadsheets/d/1POtF_xQXIB88bn-VIvCxGSI5ymqwrOC0RqNnWwTl3eg/edit#gid=0"
...
Declaring output directories in drive
...
ion_crossobject_dup <-  read.cross(
  format = "csv",
...
dupmarkers <- findDupMarkers(ion_crossobject_dup, exact.only = T) %>%
  unlist(use.names = F)

ion_crossobject <- ion_crossobject_dup %>%
  drop.markers(dupmarkers)
